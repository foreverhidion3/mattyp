...
import './Matt_Game_full.css';
import { Link } from 'react-router-dom';
import play_img from "../images/play_img.png";
import back_2 from "../images/back_2.png"

function Matt_Game_full() {
  return (
    <div className="game_full_background">
      ...
      <div className="play_img_2_container">
        <Link to="/mattyp_war">
          <img src={play_img} alt="play_img_2" id="play_img_2" />
        </Link>
      </div>
    </div>
  );
