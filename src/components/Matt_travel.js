...
import matt_travel from "../images/luke_travel_1.gif";
import './Matt_travel.css';
...
function Matt_travel() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      ...
      navigate('/matt_game_over', { state: { hitsCounted, jewelsCollected } });
      console.log("Matt_travel Log", hitsCounted)
      console.log("Matt_travel Log", jewelsCollected)
  ...
  return (
    <div className="matt_travel_container">
